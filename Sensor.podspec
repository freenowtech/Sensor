#
#  Be sure to run `pod spec lint Sensor.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://sensor-swift.github.io"
  ...
  spec.author             = { "Ferran Pujol Camins" => "ferran.pujol@mytaxi.com" }
  # Or just: spec.author    = "Ferran Pujol Camins"
  # spec.authors            = { "Ferran Pujol Camins" => "ferran.pujol@mytaxi.com" }
  # spec.social_media_url   = "https://twitter.com/Ferran Pujol Camins"
  ...
  spec.source       = { :git => ".", :branch => "frameworks" }
